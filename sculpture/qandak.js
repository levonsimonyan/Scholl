...
showButton.addEventListener('click', function() {
    if (applicant.style.display === 'none') {
        applicant.style.display = 'block';
        showButton.innerHTML = 'Թաքցնել տեղեկությունը <i class="bi bi-arrow-up-short"></i>';
    } else {
        applicant.style.display = 'none';
        showButton.innerHTML = 'Տեսնել ավելի վաղ տեղեկություններ <i class="bi bi-arrow-down-short"></i>';
    }
});